...
<div class="content-wrapper">
  ...
  <div class="content-header">
    ...
    <a href="<?= base_url('tambahCustomer') ?>" class="btn btn-primary col-12 mt-3">Tambah <?= $title ?></a>
                ...
                <tbody>
                  ...
                  foreach ($order as $o) : ?>
                    <tr>
                      ...
                      <td><?= $o['CompanyName'] ?></td>
                      <td>
                        <!-- <a href="<?= base_url('Admin/EditDataFakultas/' . $o['']) ?>" class="btn btn-warning">Edit</a> -->
                        <a href="<?= base_url('Admin/HapusCustomer/' . $o['CustomerID']) ?>" class="btn btn-danger btn-action" onclick="confirm('Yakin?')">Delete</a>
